...
const toFullImageUrl = (img) => {
  ...
  if (img.includes("/upload/")) {
    return img.replace("/upload/", "/upload/f_auto,q_auto,w_500/");
  }
...
const Personalized = ({ products = [] }) => {
  ...
  return (
    <section className="w-full mx-auto pt-0 pb-8 md:pb-10 px-4">
              ...
              <Link to={`/product/${id}`}>
                <div className="relative w-[165px] sm:w-64 bg-black border border-white/20 rounded-xl sm:rounded-2xl p-2 sm:p-4 hover:bg-black transition-all flex flex-col h-[280px] sm:h-[400px] overflow-hidden">
                  ...
                  <div className="flex flex-col gap-1 sm:gap-2">
                    <h3 className="text-[12px] sm:text-[15px] font-medium line-clamp-2 text-white/90">
                      {name}
                    </h3>
